  ...
  return (
    <div className='text-center'>
      ...
      <div className='md:grid md:grid-cols-3'>
        ...
        {/* Titulo */}
        <div className='md:col-start-2 flex items center justify-center place-content-center gap-2 mb-3'>
        ...
        <div className='place-content-center'>
          <a className='max-md:mx-auto md:ml-auto md:mr-0 flex w-fit hover:text-slate-500' href='https://github.com/AxelGMunoz/WhoCharGame' target='_blank' rel='noreferrer'>
      ...
      selItem === -1 &&
        <>
          ...
          <div className='md:p-1 md:pr-2 md:max-h-[75vh] md:overflow-y-auto md:grid md:grid-cols-4 md:gap-4'>
            {items.map(item =>
